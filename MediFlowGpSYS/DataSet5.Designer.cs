...
namespace MediFlowGpSYS {
    ...
    public partial class DataSet5 : global::System.Data.DataSet {
        ...
        public partial class APPOINTMENTDataTable : global::System.Data.TypedTableBase<APPOINTMENTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public APPOINTMENTRow AddAPPOINTMENTRow(decimal APPID, decimal MDN, decimal MRN, System.DateTime ARRIVALDATE, System.DateTime ARRIVALTIME, decimal FEES, string APPSTATUS, string PAYMENTSTATUS) {
        ...
        public partial class APPOINTMENTRow : global::System.Data.DataRow {
            ...
            public decimal MDN {
                get {
                    return ((decimal)(this[this.tableAPPOINTMENT.MDNColumn]));
                }
                set {
                    this[this.tableAPPOINTMENT.MDNColumn] = value;
                }
            }
            ...
            public System.DateTime ARRIVALTIME {
                get {
                    return ((global::System.DateTime)(this[this.tableAPPOINTMENT.ARRIVALTIMEColumn]));
                }
                set {
...
namespace MediFlowGpSYS.DataSet5TableAdapters {
    ...
    public partial class APPOINTMENTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""T00228562"".""APPOINTMENT"" WHERE ((""APPID"" = :Original_APPID) AND (""MDN"" = :Original_MDN) AND (""MRN"" = :Original_MRN) AND (""ARRIVALDATE"" = :Original_ARRIVALDATE) AND (""ARRIVALTIME"" = :Original_ARRIVALTIME) AND (""FEES"" = :Original_FEES) AND (""APPSTATUS"" = :Original_APPSTATUS) AND (""PAYMENTSTATUS"" = :Original_PAYMENTSTATUS))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("Original_ARRIVALTIME", global::System.Data.OracleClient.OracleType.Timestamp, 0, global::System.Data.ParameterDirection.Input, "ARRIVALTIME", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"T00228562\".\"APPOINTMENT\" (\"APPID\", \"MDN\", \"MRN\", \"ARRIVALDATE\", \"ARR" +
                "IVALTIME\", \"FEES\", \"APPSTATUS\", \"PAYMENTSTATUS\") VALUES (:APPID, :MDN, :MRN, :AR" +
                "RIVALDATE, :ARRIVALTIME, :FEES, :APPSTATUS, :PAYMENTSTATUS)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("ARRIVALTIME", global::System.Data.OracleClient.OracleType.Timestamp, 0, global::System.Data.ParameterDirection.Input, "ARRIVALTIME", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""T00228562"".""APPOINTMENT"" SET ""APPID"" = :APPID, ""MDN"" = :MDN, ""MRN"" = :MRN, ""ARRIVALDATE"" = :ARRIVALDATE, ""ARRIVALTIME"" = :ARRIVALTIME, ""FEES"" = :FEES, ""APPSTATUS"" = :APPSTATUS, ""PAYMENTSTATUS"" = :PAYMENTSTATUS WHERE ((""APPID"" = :Original_APPID) AND (""MDN"" = :Original_MDN) AND (""MRN"" = :Original_MRN) AND (""ARRIVALDATE"" = :Original_ARRIVALDATE) AND (""ARRIVALTIME"" = :Original_ARRIVALTIME) AND (""FEES"" = :Original_FEES) AND (""APPSTATUS"" = :Original_APPSTATUS) AND (""PAYMENTSTATUS"" = :Original_PAYMENTSTATUS))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("ARRIVALTIME", global::System.Data.OracleClient.OracleType.Timestamp, 0, global::System.Data.ParameterDirection.Input, "ARRIVALTIME", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("Original_ARRIVALTIME", global::System.Data.OracleClient.OracleType.Timestamp, 0, global::System.Data.ParameterDirection.Input, "ARRIVALTIME", global::System.Data.DataRowVersion.Original, false, null));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT APPID, MDN, MRN, ARRIVALDATE, ARRIVALTIME, FEES, APPSTATUS, PAYMENTSTATUS " +
                "FROM T00228562.APPOINTMENT";
        ...
        public virtual int Fill(DataSet5.APPOINTMENTDataTable dataTable) {
        ...
        public virtual DataSet5.APPOINTMENTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet5.APPOINTMENTDataTable dataTable = new DataSet5.APPOINTMENTDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet5.APPOINTMENTDataTable dataTable) {
        ...
        public virtual int Delete(decimal Original_APPID, decimal Original_MDN, decimal Original_MRN, System.DateTime Original_ARRIVALDATE, System.DateTime Original_ARRIVALTIME, decimal Original_FEES, string Original_APPSTATUS, string Original_PAYMENTSTATUS) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((decimal)(Original_APPID));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((decimal)(Original_MDN));
            this.Adapter.DeleteCommand.Parameters[2].Value = ((decimal)(Original_MRN));
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((decimal)(Original_FEES));
            if ((Original_APPSTATUS == null)) {
                throw new global::System.ArgumentNullException("Original_APPSTATUS");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_APPSTATUS));
            }
        ...
        public virtual int Insert(decimal APPID, decimal MDN, decimal MRN, System.DateTime ARRIVALDATE, System.DateTime ARRIVALTIME, decimal FEES, string APPSTATUS, string PAYMENTSTATUS) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((decimal)(APPID));
            this.Adapter.InsertCommand.Parameters[1].Value = ((decimal)(MDN));
            this.Adapter.InsertCommand.Parameters[2].Value = ((decimal)(MRN));
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((decimal)(FEES));
            if ((APPSTATUS == null)) {
                throw new global::System.ArgumentNullException("APPSTATUS");
            }
            else {
        ...
        public virtual int Update(
                    ...
                    decimal Original_MDN, 
                    decimal Original_MRN, 
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((decimal)(MDN));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((decimal)(MRN));
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((decimal)(FEES));
            if ((APPSTATUS == null)) {
                throw new global::System.ArgumentNullException("APPSTATUS");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((decimal)(Original_MDN));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((decimal)(Original_MRN));
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((decimal)(Original_FEES));
            if ((Original_APPSTATUS == null)) {
                throw new global::System.ArgumentNullException("Original_APPSTATUS");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_APPSTATUS));
            }
            if ((Original_PAYMENTSTATUS == null)) {
                throw new global::System.ArgumentNullException("Original_PAYMENTSTATUS");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(decimal MDN, decimal MRN, System.DateTime ARRIVALDATE, System.DateTime ARRIVALTIME, decimal FEES, string APPSTATUS, string PAYMENTSTATUS, decimal Original_APPID, decimal Original_MDN, decimal Original_MRN, System.DateTime Original_ARRIVALDATE, System.DateTime Original_ARRIVALTIME, decimal Original_FEES, string Original_APPSTATUS, string Original_PAYMENTSTATUS) {
            return this.Update(Original_APPID, MDN, MRN, ARRIVALDATE, ARRIVALTIME, FEES, APPSTATUS, PAYMENTSTATUS, Original_APPID, Original_MDN, Original_MRN, Original_ARRIVALDATE, Original_ARRIVALTIME, Original_FEES, Original_APPSTATUS, Original_PAYMENTSTATUS);
        }
    }
